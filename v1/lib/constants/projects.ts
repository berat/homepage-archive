export default [
  ...
  {
    name: 'Görsel Arama',
    description: 'Unsplash üzerinden görsel arama projesi.',
    keywords: ['Typescript', 'React', 'Redux', 'SCSS'],
    url: 'https://github.com/berat/hipo-case',
    icon: '🖼️'
  },
  {
    name: 'Film/Dizi Arama',
    description: 'Hazır veriler üzerinden film/dizi arama projesi.',
    keywords: ['Typescript', 'Angular', 'SCSS'],
    url: 'https://github.com/berat/angular-example',
    icon: '🍿'
  },
  {
    name: 'WordBox',
