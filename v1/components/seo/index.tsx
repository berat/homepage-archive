...
const SEO: React.FC<SEOProps> = ({ title, description, image }) => {
  ...
  return (
    <Head>
      <title>{title ? `${title} | ${general.author.name}` : general.title}</title>
      ...
      />
      <meta property="og:image" content={image ?? general.image} />
      ...
      <meta
        ...
        content={description ?? general.description}
      />
      <meta name="twitter:image" content={image ?? general.image} />
